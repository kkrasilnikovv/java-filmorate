...
public class FriendDaoTest {
    ...
    public void updateDatabase(){
        userStorage.reset();
        userStorage.addUser(new User(1,"Ivan", "mail@mail.ru", "CoolMan",
                LocalDate.of(2003, 3, 31)));
        userStorage.addUser(new User(2,"Alex", "yandex@yandex.ru", "BadMan",
                LocalDate.of(2012, 5, 10)));
        userStorage.addUser(new User(3,"Sasha", "google@yandex.ru", "smallMan",
    ...
    public void getUserCrossFriendsTest(){
        ...
        if(userStorage.getUserById(1).isPresent() && userStorage.getUserById(2).isPresent()) {
            storage.getUserCrossFriends(1, 2);
